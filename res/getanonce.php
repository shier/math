...
$strsql="SELECT * from newslib where showMode=2 and delMode=0 order by ordrerList  limit 0,5";
...
while($row = mysql_fetch_array($result)){
    ...
    $outStr.='<td width=19 class="annonce_splice">|</td><td width=152><span class="annonce_title" id=' . $row[id] .'>' .formatDatau($title,9).'</span><br /><span class="annonce_content">';
